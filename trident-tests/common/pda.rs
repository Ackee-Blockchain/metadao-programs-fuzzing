...
pub fn get_change_request_pda(trident: &mut Trident, performance_package: Pubkey, proposer: Pubkey, pda_nonce: u32) -> Pubkey {
    trident
        .find_program_address(
...
pub fn get_pool_pda(trident: &mut Trident, config: Pubkey, base_mint: Pubkey, quote_mint: Pubkey) -> Pubkey {
